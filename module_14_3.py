...
api = "8196236434:AAH0lHODRM8phlkhBCFqMT9U38ZdHlVBJ7w"
bot = Bot(token=api)
...
async def get_buying_list(message: types.Message):
    products = [
        ('Видеокарта', 'NVIDIA Geforce RTX 5090', 2000, 'https://cdn-icons-png.flaticon.com/512/2004/2004611.png'),
        ('Процессор', 'Ryzen 7 9800x3d', 500, 'https://cdn-icons-png.flaticon.com/512/3716/3716484.png'),
        ('Оперативная память', 'ADATA XPG Lancer Blade 32gb 6000 MHZ (2x16)', 100, 'https://cdn-icons-png.flaticon.com/512/2764/2764252.png'),
        ('Материнская плата', 'ASUS TUF B650-Plus', 250, 'https://cdn-icons-png.flaticon.com/512/2287/2287895.png')
    ]
    for product in products:
        await message.answer_photo(product[3], caption=f'Название: {product[0]} | Описание: {product[1]} | Цена: {product[2]}')
